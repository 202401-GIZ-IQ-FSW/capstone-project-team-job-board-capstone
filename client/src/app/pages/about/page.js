  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <div class="justify-center	max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6 text-center">
        ...
        <img class="w-6 h-6 rounded-full" src="https://avatars.design/wp-content/uploads/2022/09/Professional-Avatar-Illustration-234.png" alt="profile picture avatar onluine"></img>
