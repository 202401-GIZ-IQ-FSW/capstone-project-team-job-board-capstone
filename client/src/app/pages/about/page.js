...
export default function About() {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center p-24">
        ...
        <p className="mt-6 text-lg">Welcome to TechGirls Job Board, a platform created by tech girls, for tech girls. <br/>
...
<p className="mt-6 text-lg"> At TechGirls Job Board, we understand the unique challenges women face in the tech world, 
  <br/> and we are here to make a difference. <br/>
...
<p className="mt-6 text-lg ">Join us in building a more inclusive tech industry. <br/>
   Explore job listings, find your dream role, and become a part of our vibrant community.<br/>
    ...
    <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
      <p class="text-2xl font-medium text-gray-900 dark:text-white">"Thanks to your support, I was able to get an internship at Avesta group. Now, I'm at the end of the internship and got a job offer!"</p>
      ...
      <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700 text-center">
